...
Public Class FRamal
    ...
    End Sub
    Private Sub FRMforecasting_Activated(sender As Object, e As EventArgs) Handles MyBase.Activated
        Call Tampilitem()
        Call AturDGV()
        Call buka()
    ...
    Private Sub TampilCombo()
        ...
        If baca.HasRows Then
            Do While baca.Read
                ...
                cmdcek4 = New SqlCommand(cek4, koneksi)
                jmlrowx = cmdcek4.ExecuteScalar
                jmlr = jmlrowx * 9
    ...
    Sub AturDGV()
        Try
            ...
            DGVforecasting.Columns(5).HeaderText = "-"
                        ...
                        If (x < 11) Then
                            ...
                            If (bacacek.HasRows) Then
                                ...
                                If IsDBNull(bacacek("aktual")) Then
                                    cek3 = "SELECT * FROM qty WHERE iditem = '" & iditem & "' AND nperiode = '" & perx & "'"
                                    cmdcek3 = New SqlCommand(cek3, koneksi)
                                    bacacek3 = cmdcek3.ExecuteReader
                                    bacacek3.Read()
                                    ape = bacacek3("jumlah") - f
                                    ape = Math.Round(Math.Abs(ape / bacacek3("jumlah")), 4)
                                    apestr = Replace(ape, ",", ".")
                                    simpan = "UPDATE forecasting SET hasil ='" & f & "', aktual ='" & bacacek3("jumlah") & "', ape ='" & apestr & "' WHERE idforecasting ='" & idf & "'"
                                Else
                            ...
                            Else
                                ...
                                cmd = New SqlCommand(simpan, koneksi)
                                cmd.ExecuteNonQuery()
                                cek2 = "SELECT MAX(idforecasting) FROM forecasting"
